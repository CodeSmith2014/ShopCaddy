          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="footer_teaser col-sm-4 col-md-4">
                         <h3>Latest News</h3>
                         <ul class="media-list">
                              <li class="media"> <a href="#" class="media-photo"></a> <a href="#" class="media-date">19<span>FEB</span></a>
                              ...
                              <li class="media"> <a href="#" class="media-photo"></a> <a href="#" class="media-date">18<span>FEB</span></a>
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="text-right col-sm-6 col-md-6">
                         Developed by <a href="http://codesmith.sg">CodeSmith Pte. Ltd.</a>
                    </div>
               </div>
          </div>
     </section>
